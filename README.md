...
### Result:
Thus, the GSP algorithm successfully identified frequent sequential patterns of lengths 1 to 6 from the given dataset based on the specified minimum support threshold.
